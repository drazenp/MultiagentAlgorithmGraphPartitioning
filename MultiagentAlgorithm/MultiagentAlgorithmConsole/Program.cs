            ...
            switch (algortithamTest)
            {
                case AlgortithamTest.TestMetis:
                    var optionsMetis = new Options(numberOfAnts: 2, numberOfPartitions: 2, coloringProbability: 0.9,
                        movingProbability: 0.85, graphFilePath: TestGraphFilePath, numberVerticesForBalance: 5, numberOfIterations: 5);
                ...
                case AlgortithamTest.Myciel3:
                    var optionsMyciel3 = new Options(numberOfAnts: 2, numberOfPartitions: 2, coloringProbability: 0.9,
                        movingProbability: 0.85, graphFilePath: Myciel3GraphFilePath, numberVerticesForBalance: 6, numberOfIterations: 4000);
                ...
                case AlgortithamTest.Queen55:
                    var optionsQueen55 = new Options(numberOfAnts: 3, numberOfPartitions: 2, coloringProbability: 0.9,
                        movingProbability: 0.85, graphFilePath: Queen55GraphFilePath, numberVerticesForBalance: 10, numberOfIterations: 4000);
                ...
                case AlgortithamTest.Queen88:
                    var optionsQueen88 = new Options(numberOfAnts: 4, numberOfPartitions: 4, coloringProbability: 0.9,
                        movingProbability: 0.85, graphFilePath: Queen88GraphFilePath, numberVerticesForBalance: 30, numberOfIterations: 4000);
                ...
                case AlgortithamTest.Queen1212:
                    var optionsQueen1212 = new Options(numberOfAnts: 6, numberOfPartitions: 9, coloringProbability: 0.9,
                        movingProbability: 0.85, graphFilePath: Queen1212GraphFilePath, numberVerticesForBalance: 70, numberOfIterations: 4000);
                ...
                case AlgortithamTest.Queen1616:
                    var optionsQueen1616 = new Options(numberOfAnts: 7, numberOfPartitions: 16, coloringProbability: 0.9,
                        movingProbability: 0.85, graphFilePath: Queen1616GraphFilePath, numberVerticesForBalance: 150, numberOfIterations: 4000);
                ...
                case AlgortithamTest.Myciel4:
                    var optionsMyciel4 = new Options(numberOfAnts: 2, numberOfPartitions: 2, coloringProbability: 0.9,
                        movingProbability: 0.85, graphFilePath: Myciel4GraphFilePath, numberVerticesForBalance: 12, numberOfIterations: 4000);
                ...
                case AlgortithamTest.Jean:
                    var optionsJean = new Options(numberOfAnts: 3, numberOfPartitions: 5, coloringProbability: 0.9,
                        movingProbability: 0.85, graphFilePath: JeanGraphFilePath, numberVerticesForBalance: 35, numberOfIterations: 4000);
                ...
                case AlgortithamTest.Miles500:
                    var optionsMiles500 = new Options(numberOfAnts: 7, numberOfPartitions: 8, coloringProbability: 0.9,
                        movingProbability: 0.85, graphFilePath: Miles500GraphFilePath, numberVerticesForBalance: 60, numberOfIterations: 4000);
                ...
                case AlgortithamTest.Le45015B:
                    var optionsLe45015B = new Options(numberOfAnts: 8, numberOfPartitions: 29, coloringProbability: 0.9,
                        movingProbability: 0.85, graphFilePath: Le45015bGraphFilePath, numberVerticesForBalance: 240, numberOfIterations: 4000);
